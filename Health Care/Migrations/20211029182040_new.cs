        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCanceled = table.Column<bool>(nullable: false),
                    CancelResoun = table.Column<string>(nullable: true),
                    ClinicID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(nullable: true),
                    Picture = table.Column<string>(nullable: true),
                    NumberOfSeen = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HospitalADDs", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    userId = table.Column<int>(nullable: false),
                    ExternalClinicId = table.Column<int>(nullable: false),
                    shiftAM_PM = table.Column<string>(nullable: true),
                    day = table.Column<int>(nullable: false),
                    startTime = table.Column<int>(nullable: false),
                    endTime = table.Column<int>(nullable: false),
